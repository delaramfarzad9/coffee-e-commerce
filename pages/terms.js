  ...
  return (
    <div className="bg-neutral-50 min-h-screen px-6 py-16">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-sm">
        ...
        <h1 className="text-3xl font-bold mb-6 text-chocolate">Terms & Conditions</h1>

        {/* Introduction */}
        <section className="mb-8">
          <p className="text-gray-600">
            These Terms & Conditions govern your use of the SetCoffee website and
            the purchase of products from our online store. By accessing our site
        ...
        {/* Orders */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-chocolate">1. Orders & Payments</h2>
          <p className="text-gray-600 mb-2">
            All orders are subject to availability. Prices are listed in GBP and
            include applicable taxes. Payment must be completed at checkout using
        ...
        {/* Shipping */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-chocolate">2. Shipping & Delivery</h2>
          <p className="text-gray-600">
            Delivery times are estimates and may vary due to courier delays or
            external factors. Once an order has been dispatched, we cannot modify
        ...
        {/* Returns */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-chocolate">3. Returns & Refunds</h2>
          <p className="text-gray-600 mb-2">
        ...
        {/* Product Info */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-chocolate">4. Product Information</h2>
          <p className="text-gray-600">
        ...
        {/* Website Use */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-chocolate">5. Website Use</h2>
          <p className="text-gray-600">
        ...
        {/* Updates */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-chocolate">6. Changes to Terms</h2>
          <p className="text-gray-600">
        ...
        {/* Contact */}
        <section>
          <h2 className="text-xl font-semibold mb-2 text-chocolate">Contact Us</h2>
          <p className="text-gray-600">
