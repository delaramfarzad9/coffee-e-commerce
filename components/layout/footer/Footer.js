    ...
    <footer className="w-full  pt-10  text-amber-900 bg-orange-100">
      ...
      <div className="flex flex-col gap-7 justify-between items-start md:flex-row py-12 px-4 md:px-10">
        ...
        <div className="flex flex-col max-w-md gap-y-3 text-balance text-left">
          {/* logo */}
          <Logo className="mb-4 self-start justify-start" />
          {/* description */}

          <h3 className="flex ">
            Cascade Cup Company – SetCoffee Online Store
          </h3>
          ...
          <address className="flex flex-row space-x-1  text-balance not-italic items-start ">
            ...
            <p className="">
              42 Brew Lane, Shoreditch, London, E2 7RG, United Kingdom
            </p>
          </address>
          {/* Order Tracking */}
        ...
        <div className="flex flex-col gap-2 items-start text-balance text-left font-bold">
          ...
          />
          <PostItem
            title="Top 5 Coffee Beans for Winter"
            href="/blog/top-5-winter-beans"
          />
          <PostItem
            title="The Science Behind Cold Brew"
            href="/blog/science-of-cold-brew"
          />
          <PostItem
            title="Important Tips and Best Practices for Storing Coffee at Home"
            href="/blog/coffee-storage-tips"
          />
          <PostItem
            title="Optimal Time for Drinking Brewed Coffee"
            href="/blog/optimal-coffee-time"
          />
        </div>
        ...
        >
          ...
          <ul className="space-y-1 ">
            ...
            <li>
              <LinkItem href="/delivery" className="whitespace-nowrap">
                Shipping & Delivery
              </LinkItem>
            </li>
            <li>
              <LinkItem href="/support" className="whitespace-nowrap">
                Customer Support
              </LinkItem>
            </li>
            <li>
              <LinkItem href="/privacy" className="whitespace-nowrap">
                Privacy Policy
              </LinkItem>
            </li>
            <li>
              <LinkItem href="/dictionary" className="whitespace-nowrap">
                Coffee Dictionary
              </LinkItem>
            </li>
          </ul>
