  ...
  `}
      >
        ...
        <nav className="hidden sm:flex  flex-1 justify-center space-x-3 lg:space-x-4 items-center text-base md:text-lg lg:text-xl">
          <NavLink href="/" scrolled={scrolled} isHome={isHome}>
            Home
          </NavLink>
          <NavLink href="/shop" scrolled={scrolled} isHome={isHome}>
            Shop
          </NavLink>
          <NavLink href="/blog/" scrolled={scrolled} isHome={isHome}>
            Blog
          </NavLink>
          <NavLink href="/contact" scrolled={scrolled} isHome={isHome}>
            Contact
          </NavLink>
        ...
        "
          ...
          <Link href="/favorites" className="relative">
            ...
            {liked.length > 0 && (
              <div
                className="absolute -top-2 -right-2 bg-amber-900 text-white 
