    ...
    <section className="hero w-full">
      <div className="flex items-center w-full justify-start      aspect-4/3  md:h-dvh  bg-no-repeat bg-contain  md:bg-cover md:bg-bottom  bg-chatgpt ">
        <div className="flex flex-col gap-5 ">
          <h1 className=" text-[#F6F5F5] text-left text-xl sm:text-2xl md:text-5xl xl:text-6xl font-black   md:leading-snug xl:max-w-3xl max-w-1/2  md:ml-20 ml-5 md:mb-0  drop-shadow-xl mt-10 md:mt-0">
