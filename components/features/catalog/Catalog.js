    ...
    <div className={`flex flex-col gap-14  ${className}`}>
      ...
      <div className="flex items-center justify-between gap-3 px-2 sm:px-4 md:px-5">
        <div className="min-w-0">
          <h2 className="inline-block max-w-full font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-chocolate dark:text-orange-200 border-b-2 border-chocolate/30 dark:border-orange-200/30 pb-1 sm:pb-2 leading-tight">
            {title}
          </h2>
        </div>
        <Button
